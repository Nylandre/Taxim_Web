...
<body>
    ...
    <div>
        ...
        <br />
        <br />
        <asp:TextBox ID="TextBox6" runat="server" ForeColor="#999999">Ending time</asp:TextBox>
        <asp:TextBox ID="TextBox4" runat="server" ForeColor="#999999">Starting time</asp:TextBox>
        <asp:TextBox ID="TextBox5" runat="server" ForeColor="#999999">Ending time</asp:TextBox>
        <asp:TextBox ID="TextBox7" runat="server" ForeColor="#999999">Trip id</asp:TextBox>
        <br />
